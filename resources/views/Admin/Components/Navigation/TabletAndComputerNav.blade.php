<nav class="w-[250px] md:flex flex-col hidden h-full bg-[#26AF5A] border-[#808080] border-r-1 border-r fixed px-3">
    ...
    <ul class="w-full mt-3">
        <li>
            <a href="{{ route('dashboard_page') }}" class="nav-a {{ $D_TaC }}">
        ...
        <li>
            <a href="{{ route('users_page') }}" class="nav-a {{ $U_TaC }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <li>
            <a href="{{ route('questions_page') }}" class="nav-a {{ $Q_TaC }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <li>
            <a href="{{ route('feedbacks_page') }}" class="nav-a {{ $F_TaC }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
